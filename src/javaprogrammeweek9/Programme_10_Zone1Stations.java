...
public class Programme_10_Zone1Stations {
    public static void main(String[] args) {
        char result;
        //Printing Zone1 Station list to customer
        System.out.println("This is Zone 1 Station list: ");
        System.out.println("----------------------------------------------------------------------------------------------------------------------");
        System.out.println("ALGATE, EUSTON SQUARE, OXFORD CIRCUS, WATERLOO STATION, TOWER HILL, OLD STREET,                                       ");
        System.out.println("SOUTH KENSINGTON, VICTORIA STATION, LANCASTER GATE, GREEN PARK, FARRINGDON, EDGWARE ROAD                              ");
        System.out.println("QUEENSWAY, KINGS CROSS ST.PANCRAS STATION, VAUXHALL STATION, EUSTON STATION, BAYSWATER,ANGLE,PADDINGTON STATION       ");
        System.out.println("BAKER STREET, KNIGHTS BRIDGE STATION, CHARING CROSS STATION, GLOUCESTER ROAD, REGENTS PARK, HYDE PARK CORNER          ");
        System.out.println("LEICESTER SQUARE, LONDON BRIDGE STATION, PICCADILLY CIRCUS, MOORGATE, ST.PAUL'S, WESTMINISTER, HOLBORN,                ");
        ...
        zone.put("ALGATE", "Circle / Metropolitan");
